...
es["instanceTypes"]["2016.10.01"]["median"] = 'dbo:Athlete'
es["instanceTypes"]["2016.10.01"]["mode"] = 'dbo:Agent'
...
es["instanceTypes"]["2020.10.01"]["median"] = 'dbo:AdministrativeRegion'
es["instanceTypes"]["2020.10.01"]["mode"] = 'dbo:Agent'
...
es["instanceTypes"]["2021.05.01"]["median"] = 'dbo:AdministrativeRegion'
es["instanceTypes"]["2021.05.01"]["mode"] = 'dbo:Agent'
...
es["instanceTypes"]["2021.06.01"]["median"] = 'dbo:AdministrativeRegion'
es["instanceTypes"]["2021.06.01"]["mode"] = 'dbo:Agent'
...
es["uriCounts"]["2016.10.25"]["median"] = 'dbpedia-es:Hinduismo'
es["uriCounts"]["2016.10.25"]["mode"] = 'dbpedia-es:' + R.top_2016_uriCounts_es['DBpedia entity'].iloc[0]
...
es["uriCounts"]["2020.10.25"]["median"] = 'dbpedia-es:Huiracocha_Inca'
es["uriCounts"]["2020.10.25"]["mode"] = 'dbpedia-es:' + R.top_2020_uriCounts_es['DBpedia entity'].iloc[0]
...
es["uriCounts"]["2021.05.25"]["median"] = 'dbpedia-es:III_milenio_a._C.'
es["uriCounts"]["2021.05.25"]["mode"] = 'dbpedia-es:' + R.top_2021_05_uriCounts_es['DBpedia entity'].iloc[0]
...
es["uriCounts"]["2021.06.25"]["median"] = 'dbpedia-es:ITunes_Store'
es["uriCounts"]["2021.06.25"]["mode"] = 'dbpedia-es:' + R.top_2021_06_uriCounts_es['DBpedia entity'].iloc[0]
...
es["pairCounts"]["2016.10.25"]["median"] = '[hinduista - dbpedia-es:Hinduismo]'
es["pairCounts"]["2016.10.25"]["mode"] = "[" + R.top_2016_pairCounts_es['Surface form'].iloc[0] + " - " + 'dbpedia-es:'+ R.top_2016_pairCounts_es['DBpedia entity'].iloc[0] + "]"
...
es["pairCounts"]["2020.10.25"]["median"] = '[Wiracocha - dbpedia-es:Huiracocha_(dios)]'
es["pairCounts"]["2020.10.25"]["mode"] = "[" + R.top_2020_pairCounts_es['Surface form'].iloc[0] + " - " + 'dbpedia-es:'+ R.top_2020_pairCounts_es['DBpedia entity'].iloc[0] + "]"
...
es["pairCounts"]["2021.05.25"]["median"] = '[artículo - dbpedia-es:Película_de_culto]'
es["pairCounts"]["2021.05.25"]["mode"] = "[" + R.top_2021_05_pairCounts_es['Surface form'].iloc[0] + " - " + 'dbpedia-es:'+ R.top_2021_05_pairCounts_es['DBpedia entity'].iloc[0] + "]"
...
es["pairCounts"]["2021.06.25"]["median"] = '[Herois (Héroes) - dbpedia-es:Héroes_(película)]'
es["pairCounts"]["2021.06.25"]["mode"] = "[" + R.top_2021_06_pairCounts_es['Surface form'].iloc[0] + " - " + 'dbpedia-es:'+ R.top_2021_06_pairCounts_es['DBpedia entity'].iloc[0] + "]"
...
es["tokenCounts"]["2016.10.25"]["median"] = 'http://es.wikipedia.org/wiki/Imperio_almohade'
es["tokenCounts"]["2016.10.25"]["mode"] = 'http://es.wikipedia.org/wiki/'+ R.top_2016_tokenCounts_es['Wikipedia article'].iloc[0]
...
es["tokenCounts"]["2020.10.25"]["median"] = 'http://es.wikipedia.org/wiki/Idioma_ruso_en_Ucrania'
es["tokenCounts"]["2020.10.25"]["mode"] = 'http://es.wikipedia.org/wiki/'+ R.top_2020_tokenCounts_es['Wikipedia article'].iloc[0]
...
es["tokenCounts"]["2021.05.25"]["median"] = 'http://es.wikipedia.org/wiki/Impunidad'
es["tokenCounts"]["2021.05.25"]["mode"] = 'http://es.wikipedia.org/wiki/'+ R.top_2021_05_tokenCounts_es['Wikipedia article'].iloc[0]
...
es["tokenCounts"]["2021.06.25"]["median"] = 'http://es.wikipedia.org/wiki/Invierno'
es["tokenCounts"]["2021.06.25"]["mode"] = 'http://es.wikipedia.org/wiki/'+ R.top_2021_06_tokenCounts_es['Wikipedia article'].iloc[0]
...
es["sfAndTotalCounts"]["2016.10.25"]["median"] ='doris miller'
es["sfAndTotalCounts"]["2016.10.25"]["mode"] = R.top_2016_sfAndTotalCounts_es['Surface form'].iloc[0]
...
es["sfAndTotalCounts"]["2020.10.25"]["median"] = 'Ciudad del Vaticano'
es["sfAndTotalCounts"]["2020.10.25"]["mode"] = R.top_2020_sfAndTotalCounts_es['Surface form'].iloc[0]
...
es["sfAndTotalCounts"]["2021.05.25"]["median"] = 'pulmonar'
es["sfAndTotalCounts"]["2021.05.25"]["mode"] = R.top_2021_05_sfAndTotalCounts_es['Surface form'].iloc[0]
...
es["sfAndTotalCounts"]["2021.06.25"]["median"] = 'culebrera europea'
es["sfAndTotalCounts"]["2021.06.25"]["mode"] = R.top_2021_06_sfAndTotalCounts_es['Surface form'].iloc[0]
...
en["instanceTypes"]["2016.10.01"]["median"] = 'dbo:Work'
en["instanceTypes"]["2016.10.01"]["mode"] = 'dbo:Agent'
...
en["instanceTypes"]["2020.10.01"]["median"] = 'dbo:Work'
en["instanceTypes"]["2020.10.01"]["mode"] = 'dbo:Agent'
...
en["instanceTypes"]["2021.05.01"]["median"] = 'dbo:Work'
en["instanceTypes"]["2021.05.01"]["mode"] = 'dbo:Agent'
...
en["instanceTypes"]["2021.06.01"]["median"] = 'dbo:AdministrativeRegion'
en["instanceTypes"]["2021.06.01"]["mode"] = 'dbo:Agent'
...
en["uriCounts"]["2016.10.25"]["median"] = 'dbr:Latvian_constitutional_referendum,_2008'
en["uriCounts"]["2016.10.25"]["mode"] = 'dbr:' + R.top_2016_uriCounts_en['DBpedia entity'].iloc[0]
...
en["uriCounts"]["2020.10.25"]["median"] = 'dbr:Lamar_University'
en["uriCounts"]["2020.10.25"]["mode"] = 'dbr:' + R.top_2020_uriCounts_en['DBpedia entity'].iloc[0]
...
en["uriCounts"]["2021.05.25"]["median"] = 'dbr:Kyrgyzstan_national_football_team'
en["uriCounts"]["2021.05.25"]["mode"] = 'dbr:' + R.top_2021_05_uriCounts_en['DBpedia entity'].iloc[0]
...
en["uriCounts"]["2021.06.25"]["median"] = 'dbr:Kwame_Nkrumah_University_of_Science_and_Technology'
en["uriCounts"]["2021.06.25"]["mode"] = 'dbr:' + R.top_2021_06_uriCounts_en['DBpedia entity'].iloc[0]
...
en["pairCounts"]["2016.10.25"]["median"] = '[part of the Soviet Union - dbr:Latvian_Soviet_Socialist_Republic]'
en["pairCounts"]["2016.10.25"]["mode"] = "[" + R.top_2016_pairCounts_en['Surface form'].iloc[0] + " - " + 'dbr:'+ R.top_2016_pairCounts_en['DBpedia entity'].iloc[0] + "]"
...
en["pairCounts"]["2020.10.25"]["median"] = '[Lamar Softball Complex - dbr:Lamar_Softball_Complex]'
en["pairCounts"]["2020.10.25"]["mode"] = "[" + R.top_2020_pairCounts_en['Surface form'].iloc[0] + " - " + 'dbr:'+ R.top_2020_pairCounts_en['DBpedia entity'].iloc[0] + "]"
...
en["pairCounts"]["2021.05.25"]["median"] = '[Wallenpaupack - dbr:Lake_Wallenpaupack]'
en["pairCounts"]["2021.05.25"]["mode"] = "[" + R.top_2021_05_pairCounts_en['Surface form'].iloc[0] + " - " + 'dbr:'+ R.top_2021_05_pairCounts_en['DBpedia entity'].iloc[0] + "]"
...
en["pairCounts"]["2021.06.25"]["median"] = '[Lakdi ka pul - dbr:Lakdi_ka_pul]'
en["pairCounts"]["2021.06.25"]["mode"] = "[" + R.top_2021_06_pairCounts_en['Surface form'].iloc[0] + " - " + 'dbr:'+ R.top_2021_06_pairCounts_en['DBpedia entity'].iloc[0] + "]"
...
en["tokenCounts"]["2016.10.25"]["median"] = 'http://en.wikipedia.org/wiki/Kushti'
en["tokenCounts"]["2016.10.25"]["mode"] = 'http://en.wikipedia.org/wiki/'+ R.top_2016_tokenCounts_en['Wikipedia article'].iloc[0]
...
en["tokenCounts"]["2020.10.25"]["median"] = 'http://en.wikipedia.org/wiki/Klondike_Open'
en["tokenCounts"]["2020.10.25"]["mode"] = 'http://en.wikipedia.org/wiki/'+ R.top_2020_tokenCounts_en['Wikipedia article'].iloc[0]
...
en["tokenCounts"]["2021.05.25"]["median"] = 'http://en.wikipedia.org/wiki/Klas_Lund'
en["tokenCounts"]["2021.05.25"]["mode"] = 'http://en.wikipedia.org/wiki/'+ R.top_2021_05_tokenCounts_en['Wikipedia article'].iloc[0]
...
en["tokenCounts"]["2021.06.25"]["median"] = 'http://en.wikipedia.org/wiki/Kovno_Kollel'
en["tokenCounts"]["2021.06.25"]["mode"] = 'http://en.wikipedia.org/wiki/'+ R.top_2021_06_tokenCounts_en['Wikipedia article'].iloc[0]
...
en["sfAndTotalCounts"]["2016.10.25"]["median"] = 'Deep Cove'
en["sfAndTotalCounts"]["2016.10.25"]["mode"] = R.top_2016_sfAndTotalCounts_en['Surface form'].iloc[0]
...
en["sfAndTotalCounts"]["2020.10.25"]["median"] = 'The Herald'
en["sfAndTotalCounts"]["2020.10.25"]["mode"] = R.top_2020_sfAndTotalCounts_en['Surface form'].iloc[0]
...
en["sfAndTotalCounts"]["2021.05.25"]["median"] = 'DC Comics'
en["sfAndTotalCounts"]["2021.05.25"]["mode"] = R.top_2021_05_sfAndTotalCounts_en['Surface form'].iloc[0]
...
en["sfAndTotalCounts"]["2021.06.25"]["median"] = 'Cyropaedia'
en["sfAndTotalCounts"]["2021.06.25"]["mode"] = R.top_2021_06_sfAndTotalCounts_en['Surface form'].iloc[0]
